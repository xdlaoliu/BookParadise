...
<head>
  ...
  <script type="text/javascript" src="${pageContext.request.contextPath}/scripts/bookedit.js" ></script>
</head>
<body>
<div class="container">
  <div class="row">
    <div class="col-sm-8 col-sm-offset-2">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <form id="bookForm" method="post" class="form-horizontal" enctype="multipart/form-data" action="<%= request.getContextPath()%>/handlebook/update">

            <div class="form-group" hidden>
              <label class="col-sm-4 control-label" for="bookid">Book ID</label>
              <div class="col-sm-5">
                <input contenteditable="false" type="text" class="form-control" id="bookid" name="bookid" placeholder="bookid" value="${book.bookid}"/>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5">
                <input type="text" class="form-control" id="bookname" name="bookname" placeholder="Bookname" value="${book.bookname}"/>
              </div>
